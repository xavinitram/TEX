...
79/159 registered stdlib functions are exercised by an example. The 80 below are not — a nudge to add one, not a build break:

`acescg_to_linear`, `apply_lut3d`, `asin`, `atop`, `bilateral_filter`, `ceil`, `char_at`, `color_burn`, `color_dodge`, `contains`, `convolve`, `cosh`, `count`, `cross`, `debug_print`, `degrees`, `determinant`, `dilate`, `endswith`, `erode`, `fetch_time`, `find`, `fit`, `hard_light`, `hash`, `hash_float`, `hash_int`, `img_height`, `img_mean`, `img_median`, `img_sum`, `img_width`, `inverse`, `join`, `len`, `linear_light`, `linear_to_acescg`, `linear_to_rec709`, `linear_to_srgb`, `lstrip`, `matches`, `normalize`, `oklab_from_rgb`, `oklab_to_rgb`, `over`, `pad_left`, `pad_right`, `patch_dist`, `premultiply`, `rec709_to_linear`, `reflect`, `repeat`, `replace`, `reverse`, `ridged`, `round`, `rstrip`, `sample_frame`, `sample_time`, `select`, `sign`, `sinh`, `split`, `srgb_to_linear`, `startswith`, `str`, `str_reverse`, `substr`, `tanh`, `to_float`, `to_int`, `trunc`, `under`, `unpremultiply`, `upper`, `viewer_exposure`, `viewer_gamma`, `vivid_light`, `voronoi`, `worley_id`
