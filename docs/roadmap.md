...
- **PM-11** (v0.40.1, pencil — deferred from v0.40.0 at the release cut; COLOR-1's other three lanes
  shipped v0.40.0): the fused viewer transform (working → display, ACES RRT/ODT-class) cooks inside
  the same program as the comp — the proof that COLOR-1 landed as a codegen seam rather than as a
  linked library.
...
| v0.40.1 | **The last mile of linear light** — the fused viewer transform | PM-11 (COLOR-1 lane C, the fused viewer-transform seam), deferred from v0.40.0 (see that row) | — |
